...
// import { useNavigate } from 'react-router-dom';
// import ChatOptionsModal from './ChatOptionModal';
// import useFetchSingleChatRooms from '@/hooks/useFetchSingleChatRooms';

// const SingleChatList = () => {
//   const [isModalOpen, setIsModalOpen] = useState(false);
//   const [selectedChat, setSelectedChat] = useState<{ name: string; profileImage: string } | null>(null);
//   const navigate = useNavigate();

//   const { chatRooms, loading, error } = useFetchSingleChatRooms();

//   const openModal = (chat: { name: string; profileImage: string }) => {
//     setSelectedChat(chat);
//     setIsModalOpen(true);
//   };
