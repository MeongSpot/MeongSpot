...
const NearbySpotCard = ({ spot }: NearbySpotCardProps) => (
  <div>
    ...
    <button className="absolute bottom-0 right-6 bg-light-orange text-white px-10 py-2 rounded-full text- hover:bg-deep-coral transition-colors">
      이동하기
    </button>
  </div>
);
