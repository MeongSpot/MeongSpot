        ...
        <div className="flex flex-col justify-center items-center space-y-5 mt-4">
          ...
          <div className="w-full grid grid-cols-3 items-center">
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <p className="text-zinc-800 font-semibold">{(selectedDog?.monthlyWalkDistance || 0).toFixed(2)}Km</p>
            </div>
            <div className="flex flex-col justify-center items-center">
              <p className="text-sm text-zinc-500">산책 시간</p>
              <p className="text-zinc-800 font-semibold">
                {selectedDog?.monthlyWalkTime ? `${selectedDog.monthlyWalkTime}분` : '0분'}
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="space-y-5">
                ...
                <div className="w-full grid grid-cols-2 items-center">
                  <div className="flex flex-col justify-center items-center">
                    <p className="text-sm text-zinc-500">산책 거리</p>
                    <p className="text-zinc-800 font-semibold">{(log.distance || 0).toFixed(2)}Km</p>
                  </div>
                  <div className="flex flex-col justify-center items-center">
                    <p className="text-sm text-zinc-500">산책 시간</p>
                    <p className="text-zinc-800 font-semibold">{log.time ? `${log.time}분` : '0분'}</p>
                  </div>
                </div>
              </div>
            </div>
